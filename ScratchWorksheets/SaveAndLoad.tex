...
\leftline{\includegraphics[scale=.20]{1.png} \includegraphics[scale=.20]{2.png} \includegraphics[scale=.20]{3.png}}

\item {\large \textbf{Re-name Your Program To Todays Date}}

\leftline{\includegraphics[scale=.30]{4.jpg} \includegraphics[scale=.30]{5.png} }

\item {\large \textbf{Open Google Drive To Your Folder}}

\leftline{ \includegraphics[scale=.20]{7.png} \includegraphics[scale=.25]{8.png}
	\includegraphics[scale=.20]{9.png} }


\item {\large \textbf{Upload Your Program}}

\leftline{ \includegraphics[scale=.20]{10.png} \includegraphics[scale=.20]{11.jpg}
